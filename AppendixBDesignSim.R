# AppendixBDesignSim.R
# This R code runs the simulations used to produce Tables B1 and B2 in Appendix B.
...
# Simulation Settings
tau2 = 0.01 # 0.01,0.1 # Setting tau2 to 0.1 gives the results used for Table B2
m = 8 # m = 8, 9
